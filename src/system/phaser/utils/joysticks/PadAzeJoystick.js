...
export default class CrossAzeJoystick extends Joystick {
    ...
    constructor(game, parent) {
        ...
        new Button(this.game, padV, Keyboard.UP, 0, 0, 'joystick_pad_fleche');
        new Button(this.game, padV, Keyboard.DOWN, 0, 120, 'joystick_pad_r');
        ...
        const leftB = new Button(this.game, padH, Keyboard.LEFT, 0, 0, 'joystick_pad_fleche', {angle: -90});
        const rightB = new Button(this.game, padH, Keyboard.RIGHT, 0, 0, 'joystick_pad_fleche', {angle: 90});
        ...
        new Button(this.game, aze, Keyboard.A, 0, 0, 'joystick_button_a');
        new Button(this.game, aze, Keyboard.E, 125, -60, 'joystick_button_e');
        new Button(this.game, aze, Keyboard.Z, 250, -120, 'joystick_button_z');
