...
export default class CrossAJoystick extends Joystick {
    ...
    constructor(game, parent) {
        ...
        new Button(this.game, cross, Keyboard.LEFT, 0, 0, 'cross', {angle: 0});
        new Button(this.game, cross, Keyboard.UP, 0, 0, 'cross', {angle: 90});
        new Button(this.game, cross, Keyboard.RIGHT, 0, 0, 'cross', {angle: 180});
        new Button(this.game, cross, Keyboard.DOWN, 0, 0, 'cross', {angle: 270});
