...
export default class Rules extends State {
    ...
    create() {
        this.game.add.text(this.game.uiScale(80), this.game.uiScale(80), "Le balisage de zones",
            {font: 'Arial', fill: '#272727', fontSize: this.game.uiScale(21)});

        this.game.add.text(this.game.uiScale(80), this.game.uiScale(160),
            "Sur un chantier se trouvent de nombreuses zones de danger. Pour plus de sécurité, il faut toutes les baliser.",
            {
