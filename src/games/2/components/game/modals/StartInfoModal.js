        ...
        return {
            ...
            items: {
                ...
                description: {
                    ...
                    "Avant de partir, repère  les  risques et dangers, puis utilise sous forme de glissé-déposé les " +
                    "différents éléments mis  à  ta disposition pour sécuriser au mieux ton chantier. \n\n" +
                    "N'hésite pas à solliciter Gabator si tu as besoin d'aide.",
                    style: {
                        fill: "#5F4D21",
                        fontFamily: "Arial",
                        fontSize: 14,
