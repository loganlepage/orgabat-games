...
export default class Rules extends State {
    ...
    create() {
        this.game.add.text(this.game.uiScale(80), this.game.uiScale(80), "Les équipements de protection",
            {font: 'Arial', fill: '#272727', fontSize: this.game.uiScale(21)});

        this.game.add.text(this.game.uiScale(80), this.game.uiScale(160),
            "Choisir les équipements de protection  adaptés à chaque situation.",
            {
