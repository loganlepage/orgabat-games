...
import PlayerQuest from "../quests/PlayerQuest";
import EnterQuest from "../quests/EnterQuest";
import StartStepQuest from "../quests/StartStepQuest";
import QcmQuest from "../quests/QcmQuest";
import EndStepQuest from "../quests/EndStepQuest";
...
class Engine {
    ...
    constructor(gameProcess) {
        ...
        this.gameProcess.quests.add(new PlayerQuest(this.gameProcess.game));
        this.gameProcess.quests.add(new EnterQuest(this.gameProcess.game));
        this.gameProcess.quests.add(new StartStepQuest(this.gameProcess.game));
        this.gameProcess.quests.add(new QcmQuest(this.gameProcess.game));
        this.gameProcess.quests.add(new EndStepQuest(this.gameProcess.game));
