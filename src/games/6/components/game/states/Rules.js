...
export default class Rules extends State {
    ...
    create() {
        ...
        this.game.add.text(this.game.uiScale(80), this.game.uiScale(160),
            "Vous arrivez à 8h00 à l’atelier et votre maître d’apprentissage vous demande de charger les matériels et matériaux dans le véhicule afin de réaliser un chantier de peinture.",
            {
