...
export default {
    ...
    items: {
        materiaux: {
            ...
            map3: {needed: true, title: "map", x: 906, y: 647, clicked: false},
            map4: {needed: true, title: "map", x: 906, y: 621, clicked: false},
            map5: {needed: true, title: "map", x: 983, y: 673, clicked: false},
            map6: {needed: true, title: "map", x: 983, y: 647, clicked: false},
            map7: {needed: true, title: "map", x: 906, y: 595, clicked: false},
        }, materiels: {
            bache: {needed: false, title: "bache", x: 724, y: 556, clicked: false},
            aspirateur: {needed: true, title: "aspirateur", x: 1138, y: 563, clicked: false},
            ponceuse: {needed: true, title: "ponceuse", x: 1090, y: 300, clicked: false},
            caisse: {needed: true, title: "caisse", x: 1009, y: 492, clicked: false},
            chariot: {needed: false, title: "chariot", x: 776, y: 711, clicked: false},
            escabeau: {needed: false, title: "escabeau", x: 802, y: 375, clicked: false},
