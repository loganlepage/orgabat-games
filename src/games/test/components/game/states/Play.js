...
export default class Play extends State {
    ...
    addEnemies() {
        this.game.enemyGroup = new EnemyFactory(this.game, Config.entities.enemies);
        this.game.enemyGroup.forEach((ghost) => {
            //add events here (like :)
            //ghost.obj.onEat.add(this.eat, this);
        });
    }
...
class GameProcess {
    constructor(playState) {
         ...
         * ON PREPARE LE TEST
         */
        this.game.playTest = new PlayTest(this.game);
