...
export default class Rules extends State {
    ...
    create() {
        this.game.add.text(this.game.uiScale(80), this.game.uiScale(80), "Gestion de l'espace de travail sur le chantier",
            {font: 'Arial', fill: '#272727', fontSize: this.game.uiScale(21)});

        this.game.add.text(this.game.uiScale(80), this.game.uiScale(160),
            "Sur les chantiers, de nombreux facteurs favorisent la pénibilité au travail. Il est préférable de trouver des moyens pour favoriser le confort au travail.",
            {
