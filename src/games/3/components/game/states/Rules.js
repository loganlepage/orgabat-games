...
export default class Rules extends State {
    ...
    create() {
        this.game.add.text(this.game.uiScale(80), this.game.uiScale(80), "Repli de chantier : traitement des déchets.",
            { font: 'Arial', fill: '#272727', fontSize: this.game.uiScale(21) });

        this.game.add.text(this.game.uiScale(80), this.game.uiScale(160),
            "Le chantier est terminé, votre employeur vous demande donc de le nettoyer. \n" +
            "Repérer les déchets et savoir les trier en utilisant les Équipements de Protection Individuel adaptés.",
