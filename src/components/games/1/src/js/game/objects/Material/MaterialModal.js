 ...
 * @type {MaterialModal}
 */
Game.Object.MaterialModal = class MaterialModal extends MyPhaser.Modal {
    ...
    infoBox() {
        ...
        Game.modals.update({type: "x", value: this.obj.sprite.x - bg._frame.centerX * Game.Manager.ModalScale}, modalName, -1);
        ...
        if(dir === "top")
            Game.modals.update({type: "y", value: this.obj.sprite.y
            - this.obj.sprite.height * (1 - this.obj.sprite.anchor.x) - bg._frame.height * Game.Manager.ModalScale}, modalName, -1);
        ...
        Game.modals.update({type: "_offsetY", value: this.getAlignCenterY(bg, title) + (dir === "top" ? -3 : 9) * Game.Manager.ModalScale}, modalName, 1);
    ...
    fixedInfoBox(amountText) {
        ...
        Game.modals.update({type: "_offsetX", value: 12 * Game.Manager.ModalScale}, modalName, 1);
        Game.modals.update({type: "_offsetY", value: ((dir === "top" ? 25 : 37) - 10) * Game.Manager.ModalScale}, modalName, 1);
        Game.modals.update({type: "_offsetX", value: 12 * Game.Manager.ModalScale}, modalName, 2);
        Game.modals.update({type: "_offsetY", value: ((dir === "top" ? 25 : 37) + 10) * Game.Manager.ModalScale}, modalName, 2);

        //A
        Game.modals.update({type: "x", value: this.getAlignRightX(bg, take) - 10 * Game.Manager.ModalScale}, modalName, 3);
        Game.modals.update({type: "y", value: this.getAlignCenterY(bg, title) + (dir === "top" ? -20 : -14) * Game.Manager.ModalScale}, modalName, 3);
        //E
        Game.modals.update({type: "x", value: this.getAlignRightX(bg, drop) - 10 * Game.Manager.ModalScale}, modalName, 4);
        Game.modals.update({type: "y", value: this.getAlignCenterY(bg, title) + (dir === "top" ? 8 : 14) * Game.Manager.ModalScale}, modalName, 4);
