...
Game.Config.data = {
        ...
        vehicles: [ //names are unique
            {
                ...
                prop: {speed: 6, speedRotate: 30, player_x: 0.5, player_y: -0.35, walkToMove: false, name: "Chariot élévateur",
            ...
            },
            {
                ...
                prop: {speed: 5, speedRotate: 50, player_x: 0.5, player_y: -0.25, walkToMove: true, name: "Brouette",
            ...
            },
            {
                ...
                prop: {speed: 5, speedRotate: 30, player_x: 0.5, player_y: -1, walkToMove: true, name: "Transpalette",
    ...
    modals: {
        assets: [
            ...
            {name: "big_infobulle", file: "big_infobulle.png"},
