 ...
 * @type {{preload: Game.State.loadState.preload, loadAssets: Game.State.loadState.loadAssets, showLoadingText: Game.State.loadState.showLoadingText, create: Game.State.loadState.create}}
 */
