 ...
 * @type {{developer: {debug: boolean}, canvasParent: string, tilesmap: {name: string, calques: string[], file: string, tiles: {width: number, height: number, size: number}, assets: *[]}, entities: {player: {x: number, y: number, speed: number}, vehicles: *[], materials: *[], tools: *[], assets: *[]}, modals: {assets: *[]}}}
 */
Game.Config.data = {
    developer: {
        debug: false
