 ...
 * @type {ToolModal}
 */
Game.Object.ToolModal = class ToolModal extends MyPhaser.Modal {
    ...
    fixedInfoBox(amountText) {
        ...
        Game.modals.update({type: "y", value: this.getAlignCenterY(bg, title) + (dir === "top" ? -3 : 9) * Game.Manager.ModalScale}, modalName, 3);
